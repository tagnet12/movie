...
function reviewDtl() {
  ...
  const [inputPwd, setInputPwd] = useState('');
    const [onAfter, setOnAfter] = useState('');
  ...
  const handleUpdate = async (inputPwd) => {
    ...
    try {
      ...
      setOnAfter(true);  // ✅ 확인버튼 클릭 후 모달창이 닫힌 뒤에 목록페이지로 이동
      ...
      <div className="movie-form-container">   
        ...
        <InputMsgBox showModal={showInputModal} modalMessage={inputModalMessage} 
          onClose={()=>{ setShowInputModal(false); inputModalMsg(''); 
            ...
            if (onAfter) {
              setOnAfter(false); navigate('/review');
            }
          }} action={action} 
