...
function Title(){
  ...
  let [slideDirection, setSlideDirection] = useState('');  // 이미지 슬라이드 방향
           ...
           !isReviewPage && Array.isArray(movies) && movies.length > 0 &&(
            <>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="w-96 h-64 overflow-hidden rounded-lg mb-6 relative" style={{ position: 'relative' }}>
                  ...
                  {/* 배너버튼 */}
                  <button className="nav-button prev" onClick={ prev } style={{ position: 'absolute', top: '50%', left: '10px', transform: 'translateY(-50%)', zIndex: 10 }}>&lt;</button>
                  <button className="nav-button next" onClick={ next } style={{ position: 'absolute', top: '50%', right: '10px', transform: 'translateY(-50%)', zIndex: 10 }}>&gt;</button>                 
                </div>
              </div>
